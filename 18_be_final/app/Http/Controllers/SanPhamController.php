...
use App\Exports\ExcelDsSanPhamExport;
use App\Http\Requests\SanPhamThemMoiRequest;
...
class SanPhamController extends Controller
{
    ...
    public function store(SanPhamThemMoiRequest $request)
    {
    ...
    public function xuatExcelSanPham()
    {
        ...
        return Excel::download(new ExcelDsSanPhamExport($data), 'san_pham.xlsx');
    }
