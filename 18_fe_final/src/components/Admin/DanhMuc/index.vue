      ...
      <div class="col-lg-5">
         <div class="card">
            <div class="card-header">
               <h4 class="mt-2"><b>THÊM MỚI DANH MỤC</b></h4>
      ...
      <div class="col-lg-7">
         <div class="card">
            <div class="card-header d-flex justify-content-between">
               <h4 class="mt-2"><b>DANH SÁCH DANH MỤC</b></h4>
               <button v-on:click="xuatExcelDsDanhMuc()" class="btn btn-success "><i class="fa-regular fa-file-excel"></i> Xuất
                  Excel</button>
            </div>
                  ...
                  <tbody>
                     <template v-for="(value, index) in list_danh_muc" :key="index">
                        <tr>
                           ...
                           <td class="align-middle">
                              <button v-on:click="changeTrangThai(value)" v-if="value.tinh_trang == 1" class="btn btn-success w-100">Hiển thị</button>
                              <button v-on:click="changeTrangThai(value)" v-else class="btn btn-warning w-100">Tạm tắt</button>
                           </td>
                           <td class="align-middle">
                              <i>Chưa xử lý</i>
                           </td>
                           <td class="align-middle d-flex justify-content-around">
                              <button v-on:click="Object.assign(edit_danh_muc, value)" class="btn btn-info me-2"
...
export default {
   ...
   methods: {
      ...
      {
         axios
                .get('http://127.0.0.1:8000/api/admin/san-pham/xuat-excel-danh-muc', {
                    responseType: 'blob',
                    headers: {
                        Authorization: 'Bearer ' + localStorage.getItem("token_nhan_vien")
                    }
                ...
                .then((res) => {
                    ...
                    link.href = url;
                    link.setAttribute('download', 'danh_muc.xlsx');
