    ...
    <div class="row">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h4>Đơn Hàng</h4>
                <button v-on:click="xuatExcelDsDonHang()" class="btn btn-success "><i class="fa-regular fa-file-excel"></i> Xuất
                    Excel</button>
            </div>
            <div class="card-body">
...
export default {
    ...
    methods: {
        ...
        {
            axios
                .get('http://127.0.0.1:8000/api/admin/don-hang/xuat-excel-don-hang', {
                    responseType: 'blob',
                    headers: {
                        Authorization: 'Bearer ' + localStorage.getItem("token_nhan_vien")
                    }
                ...
                .then((res) => {
                    ...
                    link.href = url;
                    link.setAttribute('download', 'don_hang.xlsx');
