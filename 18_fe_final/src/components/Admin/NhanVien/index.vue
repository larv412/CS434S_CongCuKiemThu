        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="mt-2"><b>DANH SÁCH NHÂN VIÊN</b></h3>
                        ...
                        <thead>
                            <tr>
                                <th colspan="100%" class="text-end">
                                    <button v-on:click="xuatExcelDsDaiLy()" class="btn btn-success"><i class="fa-regular fa-file-excel"></i> Xuất
                                        Excel</button>
                                </th>
                            </tr>
                        <tr></tr>
...
export default {
    ...
    methods: {
      ...
      {
         axios
                .get('http://127.0.0.1:8000/api/admin/nhan-vien/xuat-excel-nhan-vien', {
                    responseType: 'blob',
                    headers: {
                        Authorization: 'Bearer ' + localStorage.getItem("token_nhan_vien")
                    }
