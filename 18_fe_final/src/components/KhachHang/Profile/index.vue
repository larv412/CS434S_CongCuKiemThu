                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 text-secondary mt-3" v-if="img_tmp">
                                                        <img style="width: 150px; height: 150px;" v-bind:src="img_tmp"
                                                            alt="" class="img-fluid rounded-circle p-1 bg-primary">
                                                    </div>
                                                    <div class="col-lg-3"></div>
                                                    <div class="col-lg-9 text-secondary">
                                                        <button v-on:click="updateAvatar()" type="button"
                                                            class="btn btn-primary px-4 mt-3">Lưu ảnh</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
export default {
    ...
    methods: {
        ...
        updateAvatar() {
            ...
            axios
                .post("http://127.0.0.1:8000/api/khach-hang/profile/change-avatar", payload, {
                    headers: {
